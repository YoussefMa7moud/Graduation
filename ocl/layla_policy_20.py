...
# --- Policy Info ---
# Policy ID: 20
# Description: System databases and medical records shall be backed up automatically every 24 hours.

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
backupFrequency_prop = Property(name="backupFrequency", type=IntegerType)
basemodel_class.attributes = {backupFrequency_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.backupFrequency %3D 24',
    language="OCL"
)
...
dynamic_obj.backupFrequency = value
print(f"Set backupFrequency = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #20: 'System databases and medical records shall be backed up automatically every 24 hours.'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.backupFrequency %3D 24".strip()
