...
# --- Policy Info ---
# Policy ID: 6
# Description: age must be more then 20
...
basemodel_class.attributes = {age_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.age %3E 20',
    language="OCL"
)
...
dynamic_obj.age = value
print(f"Set age = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #6: 'age must be more then 20'")
