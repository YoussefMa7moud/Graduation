...
# --- Policy Info ---
# Policy ID: 7
# Description: employee must be from cairo

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
city_prop = Property(name="city", type=StringType)
basemodel_class.attributes = {city_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.city %3D %22cairo%22',
    language="OCL"
)
...
dynamic_obj.city = value
print(f"Set city = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #7: 'employee must be from cairo'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.city %3D %22cairo%22".strip()
