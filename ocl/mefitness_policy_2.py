...
# --- Policy Info ---
# Policy ID: 2
# Description: max number of employees writing a contract is 1

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
contractWriters_prop = Property(name="contractWriters", type=StringType)
basemodel_class.attributes = {contractWriters_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.contractWriters-%3Esize%28%29 %3D 1',
    language="OCL"
)
...
dynamic_obj.contractWriters = value
print(f"Set contractWriters = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #2: 'max number of employees writing a contract is 1'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.contractWriters-%3Esize%28%29 %3D 1".strip()
