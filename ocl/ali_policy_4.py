...
# --- Policy Info ---
# Policy ID: 4
# Description: Only authorized employees may access shipment and customer management systems.

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
role_prop = Property(name="role", type=StringType)
basemodel_class.attributes = {role_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.role %3D %22authorized%22',
    language="OCL"
)
...
dynamic_obj.role = value
print(f"Set role = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #4: 'Only authorized employees may access shipment and customer management systems.'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.role %3D %22authorized%22".strip()
