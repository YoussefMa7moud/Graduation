...
# --- Policy Info ---
# Policy ID: 13
# Description: money should be paid 2 times

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
money_prop = Property(name="money", type=StringType)
basemodel_class.attributes = {money_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression="""context BaseModel inv: self.money = 2""",
    language="OCL"
)
...
value = parse_value("one paid 1 time", "StringType")
dynamic_obj.money = value
print(f"Set money = {value}")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #13: 'money should be paid 2 times'")
