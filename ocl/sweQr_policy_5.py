...
# --- Policy Info ---
# Policy ID: 5
# Description: delivery of software should be after 50%25

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
delivery_prop = Property(name="delivery", type=StringType)
basemodel_class.attributes = {delivery_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.delivery %3E 50',
    language="OCL"
)
...
dynamic_obj.delivery = value
print(f"Set delivery = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #5: 'delivery of software should be after 50%25'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.delivery %3E 50".strip()
