...
# --- Policy Info ---
# Policy ID: 2
# Description: test covrage must be more then 60%25
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.testCoverage %3E 60',
    language="OCL"
)
...
print(f"\nTesting Policy #2: 'test covrage must be more then 60%25'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.testCoverage %3E 60".strip()
