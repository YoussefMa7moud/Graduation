...
# --- Policy Info ---
# Policy ID: 4
# Description: test covrage must be more then 80%25
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.testCoverage %3E 80',
    language="OCL"
)
...
print(f"\nTesting Policy #4: 'test covrage must be more then 80%25'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.testCoverage %3E 80".strip()
