...
# --- Policy Info ---
# Policy ID: 19
# Description: All customer and medical records must be securely stored and protected from unauthorized access.

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
securityLevel_prop = Property(name="securityLevel", type=StringType)
basemodel_class.attributes = {securityLevel_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.securityLevel %3D %22high%22',
    language="OCL"
)
...
value = extract_value_from_text(test_description, "StringType")
dynamic_obj.securityLevel = value
print(f"Set securityLevel = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #19: 'All customer and medical records must be securely stored and protected from unauthorized access.'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.securityLevel %3D %22high%22".strip()
