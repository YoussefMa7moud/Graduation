...
# --- Policy Info ---
# Policy ID: 1
# Description: employees must be from egypt
...
basemodel_class.attributes = {country_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression='context BaseModel inv: self.country %3D %22egypt%22',
    language="OCL"
)
...
dynamic_obj.country = value
print(f"Set country = {value} (from test description)")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #1: 'employees must be from egypt'")
...
if EVAL_MODE == "OCL":
    ...
    expr = "self.country %3D %22egypt%22".strip()
