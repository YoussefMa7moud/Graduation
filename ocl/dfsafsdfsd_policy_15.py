...
# --- Policy Info ---
# Policy ID: 15
# Description: payment in 2 times

# --- Context Class ---
basemodel_class = Class(name="BaseModel")

# --- Add dynamic properties ---
paymentCount_prop = Property(name="paymentCount", type=IntegerType)
basemodel_class.attributes = {paymentCount_prop}
...
POLICY_CONSTRAINT = Constraint(
    ...
    expression="""context BaseModel inv: self.paymentCount = 2""",
    language="OCL"
)
...
value = parse_value("peymen in 3 times", "IntegerType")
dynamic_obj.paymentCount = value
print(f"Set paymentCount = {value}")

context_om = ObjectModel(name="BaseModelModel", objects={dynamic_obj})


# --- Evaluate Policy Constraint ---
print(f"\nTesting Policy #15: 'payment in 2 times'")
